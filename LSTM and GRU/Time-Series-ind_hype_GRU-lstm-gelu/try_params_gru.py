...
class MyHyperModel_2(HyperModel):
    ...
    def build(self, hp):
        ...
        model.add(tf.keras.layers.GRU(params["u1"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.GRU(params["u2"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
...
class MyHyperModel_3(HyperModel):
    ...
    def build(self, hp):
        ...
        model.add(tf.keras.layers.GRU(params["u2"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.GRU(params["u3"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.Dense(1, activation='gelu'))
...
class MyHyperModel_5(HyperModel):
    ...
    def build(self, hp):
        ...
        model.add(tf.keras.layers.GRU(params["u3"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.GRU(params["u4"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.GRU(params["u5"], input_shape=(20, 10), return_sequences=True))
        model.add(tf.keras.layers.Dropout(0.05))
        model.add(tf.keras.layers.Dense(1, activation='gelu'))
